...
abstract class Lexer2
{
	...
	private final static class cc_lexer
	{
		...
		private final static char[][] next = {("\001\002").toCharArray (),("\000\000").toCharArray (),("\000\000").toCharArray ()};
	}
	...
	public int yyLex () throws IOException
	{
		...
		while (true)
		{
			...
			switch (cc_accept[cc_matchedState])
			{
				...
				case 9: break;
				default:
					throw new IOException ("Internal error in Lexer2 lexer.");
			}
	...
	private final test.Test2 m_this = (test.Test2)this;
